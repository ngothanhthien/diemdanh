...
<div class="h-screen hidden lg:block my-4 ml-4 shadow-lg relative w-80">
    <div class="bg-white h-full rounded-2xl dark:bg-gray-700">
        ...
        <nav class="mt-6">
            <div>
                <a class="sidebar" href="../layouts/diemdanh.php" id="diemdanh">
                    <span class="text-left">
                        <svg width="20" height="20" fill="currentColor" class="m-auto" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
                ...
                <a class="sidebar" href="../layouts/lich.php" id="lichday">
                    <span class="text-left">
                        <svg width="20" height="20" fill="currentColor" class="m-auto" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="mx-4 text-sm font-normal">Lịch dạy</span>
                </a>
                <a class="sidebar" href="#" id="caidat">
                    <span class="text-left">
                        <svg width="20" height="20" fill="currentColor" class="m-auto" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
                ...
                <a class="sidebar" href="../process/logout-process.php" id="dangxuat">
                    <span class="text-left">
                        <svg width="20" height="20" fill="currentColor" class="m-auto" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
