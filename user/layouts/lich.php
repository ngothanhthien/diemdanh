                            ...
                            <tbody>
                                ...
                                <tr class="text-center h-20">
                                    ...
                                    <?php for ($i = 1; $i <= 8 - $startDay; $i++) {
                                        $dayTracking++  ?>
                                        <td class="border p-1 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 overflow-auto transition duration-500 ease" id="day<?php echo $dayTracking ?>">
                                ...
                                <?php while ($dayTracking < $totalDay) { ?>
                                    <tr class="text-center h-20">
                                        <?php for ($i = 0; $i < 7; $i++) {
                                            $dayTracking++ ?>
                                            <td class="border p-1 h-40 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 overflow-auto transition duration-500 ease" id="day<?php echo $dayTracking ?>">
                                                <div class="flex flex-col h-40 mx-auto xl:w-40 lg:w-30 md:w-30 sm:w-full w-10 mx-auto">
                                                    <div class="top h-5 w-full">
                                                        <span class="text-gray-500"><?php if ($dayTracking <= $totalDay) {
                                                                                        echo $dayTracking;
                                                                                    } ?></span>
                                                    </div>
