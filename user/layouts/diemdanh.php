                        ...
                        <div class="flex flex-row mb-1 sm:mb-0 justify-between w-full">
                            <div>
                                <form class="flex flex-col md:flex-row w-3/4 md:w-full max-w-sm md:space-x-3 space-y-3 md:space-y-0 justify-center">
                                    <div class=" relative ">
                                        <select class="cursor-pointer block w-52 text-white py-2 px-3 border border-gray-300 bg-sky-500 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500" name="animals">
                                            <option value="null">
                                                Chọn môn
                                            </option>
                                            <option value="dog">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                        <div class="min-w-250 flex">
                                                            <div class="mx-2">
                                                                <input checked id="dihoc-1" type="radio" name="state[1]" value="0">
                                                                <label for="dihoc-1">Đi học</label>
                                                            </div>
                                                            <div class="mx-2">
                                                                <input id="nghihoc-1" type="radio" name="state[1]" value="1">
                                                                <label for="nghihoc-1">Nghỉ học</label>
                                                            </div>
                                                            <div class="mx-2">
                                                                <input id="cophep-1" type="radio" name="state[1]" value="2" />
                                                                <label for="cophep-1">Có phép</label>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
